...
export default function AlertsPage() {
  ...
  async function confirmDelete() {
    ...
    try {
      await deleteItem("alerts", pendingAlert.id);
      setSuccess({
        title: "Alerta eliminada",
        description: "La alerta se eliminó.",
      });
    } catch (err) {
    ...
    <div className="space-y-8">
      <div>
        ...
        <p className="text-sm text-muted-foreground">
          Avisos financieros creados automáticamente por el sistema.
        </p>
      </div>
      {error ? (
        ...
        <CardContent>
          {alerts.length ? (
                  ...
                  <TableRow key={alert.id}>
                    ...
                    <TableCell className="text-right">
                      ...
                      >
                        ...
                        <span className="sr-only">Eliminar alerta</span>
                      </Button>
                    </TableCell>
                  </TableRow>
                ))}
            ...
            <p className="py-10 text-center text-sm text-muted-foreground">
              No tienes alertas activas. Se crearán automáticamente cuando
              registres ingresos, gastos o activos.
            </p>
          )}
        </CardContent>
      </Card>
      <ConfirmDialog
        ...
        description="Se quitará de tu lista."
