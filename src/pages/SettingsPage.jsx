  ...
  async function saveProfile() {
    try {
      ...
      setSuccess({
        ...
        description: "Tus datos de cuenta se actualizaron.",
      });
    } catch (err) {
  ...
  async function savePreferences() {
    try {
      ...
      setSuccess({
        ...
        description: "Tus preferencias se actualizaron.",
      });
    } catch (err) {
  ...
  async function sendPasswordReset() {
    ...
    if (result.ok)
      setSuccess({
        ...
        description: "Firebase envió un enlace para cambiar tu contraseña.",
      });
    ...
    <div className="mx-auto max-w-4xl space-y-8">
      <div>
        ...
        <p className="mt-1 text-sm text-muted-foreground">
          Administra tu cuenta, perfil financiero y preferencias.
        </p>
      </div>
      {error ? (
        ...
        <CardContent className="space-y-5">
          ...
          <div className="space-y-2">
            ...
            <p className="text-xs text-muted-foreground">
              Cambiar correo puede requerir sesión reciente en Firebase.
            </p>
          </div>
        ...
        <CardContent className="space-y-5">
          <div className="grid gap-4 sm:grid-cols-2">
            <div className="space-y-2">
              ...
              <select
                ...
                value={preferences.currency || "MXN"}
            ...
            <div className="space-y-2">
              ...
              <select
                id="timezone"
                className={selectClassName}
                value={preferences.timezone || "America/Hermosillo"}
          ...
          <div className="max-w-xs space-y-2">
            ...
            <select
              id="monthStart"
              className={selectClassName}
              value={preferences.monthStart || "1"}
              onChange={(e) => setPreference("monthStart", e.target.value)}
            >
      ...
      <Card>
        ...
        <CardContent>
          <SettingSwitch
            ...
            description="Avisos antes del vencimiento de pagos importantes."
            checked={Boolean(preferences.paymentReminders)}
            onCheckedChange={(value) =>
              setPreference("paymentReminders", value)
            }
          />
          <Separator />
          <SettingSwitch
            ...
            onCheckedChange={(value) => setPreference("weeklySummary", value)}
          />
          <Separator />
          <SettingSwitch
            id="forecastChanges"
            ...
            checked={Boolean(preferences.forecastChanges)}
            onCheckedChange={(value) => setPreference("forecastChanges", value)}
          />
          <Button type="button" className="mt-2" onClick={savePreferences}>
      ...
      <Card className="border-destructive/30">
        <CardHeader>
          ...
          <CardDescription>
            Opciones de acceso para este dispositivo.
          </CardDescription>
        </CardHeader>
        <CardContent>
          <Button
